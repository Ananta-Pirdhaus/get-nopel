...
import 'package:nopel_get/app/modules/home/controllers/image_picker_helper.dart';
import 'package:nopel_get/app/util/profiletab_1.dart';
import 'package:nopel_get/app/util/profiletab_2.dart';
import 'package:nopel_get/app/util/profiletab_3.dart';
...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Cod3xxErr', style: TextStyle(color: Colors.black)),
